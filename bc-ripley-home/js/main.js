...
var move = false, slider_active = "online", CATEGORIAS = [ "online", "tv-video", "computo", "celulares", "electrohogar", "muebles", "dormitorio", "deco", "deporte", "infantil", "calzado", "belleza-y-accesorios", "online" ], PATH = location.host.indexOf("ripley") > -1 ? "http://www.ripley.com.pe/minisitios/campana/cyber-mama-4/" : "", BASE = "cyber-mama", filters_created = false, MARKETING_RIBBON = $(".marketing-ribbon");
...
var app = {
    ...
    init: function() {
        ...
        console.log(":: BC ::");
        var _heightHeader = $(".ripley-header").outerHeight(true), _heighCatalog = $(".catalog-header-event").outerHeight(true);
        if (!isMobile.any) {
            offset_filtros = MARKETING_RIBBON.height();
            $(window).scroll(function() {
                var fromTop = $(this).scrollTop();
                if (fromTop > offset_filtros) {} else {}
            });
        } else {
            console.log("isMobile");
